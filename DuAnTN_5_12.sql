...
INSERT [dbo].[Orders] ([Id], [Username_id], [CreateDate], [Address], [Status]) VALUES (100005, N'tuan', CAST(0x000089B100000000 AS DateTime), N'Luisenstr. 48', N'Đã thanh toán')
INSERT [dbo].[Orders] ([Id], [Username_id], [CreateDate], [Address], [Status]) VALUES (100006, N'linh', CAST(0x000089B400000000 AS DateTime), N'Rua do Paço, 67', N'Đã thanh toán')
INSERT [dbo].[Orders] ([Id], [Username_id], [CreateDate], [Address], [Status]) VALUES (100007, N'tuan', CAST(0x000089B400000000 AS DateTime), N'2, rue du Commerce', N'Đã thanh toán')
INSERT [dbo].[Orders] ([Id], [Username_id], [CreateDate], [Address], [Status]) VALUES (10008, N'tuan', CAST(0x000089B400000000 AS DateTime), N'2, rue du Commerce', N'Đã thanh toán')
INSERT [dbo].[Orders] ([Id], [Username_id], [CreateDate], [Address], [Status]) VALUES (10009, N'tuan', CAST(0x000089B400000000 AS DateTime), N'2, rue du Commerce', N'Đã thanh toán')
...
INSERT INTO [dbo].[Products] ([product_id], [product_name], [describe], [image], [price], [trademark_id], [Categories_id], [CreateDate])
VALUES
    (1, N'Eau de Blossom 1', N'Eau de Blossom Mô Tả', '1.jpg', 98622.000,1,1, CAST(0x910D0B00 AS Date)),
	(2, N'Eau de Blossom 2', N'Eau de Blossom Mô Tả', '2.jpg', 222224.000,2,2, CAST(0x910D0B00 AS Date)),
	(3, N'Eau de Blossom 3', N'Eau de Blossom Mô Tả', '3.jpg', 16845.000,3,3, CAST(0x910D0B00 AS Date)),
	(4, N'Eau de Blossom 4', N'Eau de Blossom Mô Tả', '4.jpg', 329887.000,4,4, CAST(0x910D0B00 AS Date)),
	(5, N'Eau de Blossom 5', N'Eau de Blossom Mô Tả', '5.jpg', 15978.000,5,5, CAST(0x910D0B00 AS Date)),
	(6, N'Eau de Blossom 6', N'Eau de Blossom Mô Tả', '6.jpg', 88955.000,6,1, CAST(0x910D0B00 AS Date)),
	(7, N'Eau de Blossom 7', N'Eau de Blossom Mô Tả', '7.jpg', 88896.000,7,2, CAST(0x910D0B00 AS Date)),
	(8, N'Eau de Blossom 8', N'Eau de Blossom Mô Tả', '8.jpg', 5555.000,8,3, CAST(0x910D0B00 AS Date)),
	(9, N'Eau de Blossom 9', N'Eau de Blossom Mô Tả', '9.jpg', 5457.000,9,4, CAST(0x910D0B00 AS Date)),
	(10, N'Eau de Blossom 10', N'Eau de Blossom Mô Tả', '10.jpg', 65656.000,10,5, CAST(0x910D0B00 AS Date))
